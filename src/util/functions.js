...
const REACT_NATIVE_API_KEY = process.env.REACT_NATIVE_API_KEY;
...
export const buildCivicQuery = params => {
  ...
  return `https://www.googleapis.com/civicinfo/v2/representatives?key=${REACT_NATIVE_API_KEY}&address=${paramsString}&includeOffices=true&roles=legislatorLowerBody`;
};
